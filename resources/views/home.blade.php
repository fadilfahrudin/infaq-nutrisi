...
{{-- Header --}}
    <header class="header px-3 d-flex">
        <div class="row align-items-center">
            <div class="col col-md-6">
                <img src="img/name-Landscape.png" class="w-100"   alt="">
                <h3 class="text-center mb-5">Semua bisa bergerak, Semua bisa <br> berinfaq, Semua mampu bantu sesama</h3>
    ...
    <section class="about">
        ...
        <div class="report py-5">
            <div class="row gap-1  px-5 py-3 mx-0">
                <a href="#" class="btn-report col col-sm">
        ...
        <div class="carousel py-5 px-5 ">
            <div class="row gap-5">
                ...
                <div class="about-content col-12 col-md-6 text-center lh-lg px-3">
                    ...
                    <p>Gerakan Infaq Nutrisi (GIN) merupakan sebuah gerakan mengajak masyarakat untuk saling bergerak dan membantu sesama. GIN menyalurkan kebutuhan 
                    pokok atau paket nutrisi yang sehat guna 
                    memperbaiki nutrisi keluarga.</p>
                        
                    <p> Paket nutrisi seperti beras, minyak goreng, gula, susu/madu herbal, sayuran, bumbu dapur, buah, telur/lauk, dan tempe/tahu. Paket nutrisi akan diberikan kepada keluarga dhuafa, panti asuhan, dan pesantren.</p>
                        ...
                        <div class="col-lg-12">
                            <div class="team-slider owl-carousel">
                                <div class="single-box text-center">
                                    <div class="img-area"><img alt="" class="img-fluid move-animation" src="img/bg.jpg"></div>
                                    <div class="info-area">
                                        <h4>Person's Name</h4>
                                ...
                                <div class="single-box text-center">
                                    <div class="img-area"><img alt="" class="img-fluid move-animation" src="img/1.jpg"></div>
                                    <div class="info-area">
                                        <h4>Person's Name</h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo, ullam.</p><a href="#">Learn More</a>
                                    </div>
                                ...
                                <div class="single-box text-center">
                                    <div class="img-area"><img alt="" class="img-fluid move-animation" src="img/3.jpg"></div>
                                    <div class="info-area">
                                        <h4>Person's Name</h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo, ullam.</p><a href="#">Learn More</a>
                                    </div>
